/*
  ...
  - You are about to alter the column `saleDate` on the `SaleProduct` table. The data in that column could be lost. The data in that column will be cast from `String` to `DateTime`.
